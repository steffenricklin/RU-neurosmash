...
class ConvVae(gluon.HybridBlock):
    ...
    def getEncoder(self):
        ...
        # relu conv 32 x 4
        encoder.add(nn.Conv2D(32*4, activation='relu'))
        # relu conv 64 x 4
        encoder.add(nn.Conv2D(64*4, activation='relu'))
        # relu conv 128 x 4
        encoder.add(nn.Conv2D(128*4, activation='relu'))
        # relu conv 256 x 4
        encoder.add(nn.Conv2D(256*4, activation='relu'))
